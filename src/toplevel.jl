...
function look(; coin::String="ETHBTC", candlesize::String="5m", candlesize_::Int64=5, num=450, qty=1)
    ...
    ax2.xaxis.grid(true, which="minor", linestyle="--", alpha=0.5)
    #ax2.xaxis.grid(true, which="minor", linestyle="--", alpha=0.5)
    ...
    ax3.xaxis.grid(true, which="minor", linestyle="--", alpha=0.5)
    ...
    ax4.xaxis.grid(true, which="minor", linestyle="--", alpha=0.5)
    ...
    ax5.xaxis.grid(true, which="minor", linestyle="--", alpha=0.5)
